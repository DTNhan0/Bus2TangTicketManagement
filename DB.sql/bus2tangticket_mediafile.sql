...
CREATE TABLE `mediafile` (
  ...
  KEY `mediafile_ibfk_1` (`IdBusRoute`),
  KEY `mediafile_ibfk_2` (`IdBusStop`),
  CONSTRAINT `mediafile_ibfk_1` FOREIGN KEY (`IdBusRoute`) REFERENCES `busroute` (`IdBusRoute`),
  CONSTRAINT `mediafile_ibfk_2` FOREIGN KEY (`IdBusStop`) REFERENCES `busstop` (`IdBusStop`)
