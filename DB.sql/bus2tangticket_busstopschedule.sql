...
--
-- Table structure for table `busstopschedule`
--

DROP TABLE IF EXISTS `busstopschedule`;
...
--
-- Dumping data for table `busstopschedule`
--

LOCK TABLES `busstopschedule` WRITE;
/*!40000 ALTER TABLE `busstopschedule` DISABLE KEYS */;
/*!40000 ALTER TABLE `busstopschedule` ENABLE KEYS */;
UNLOCK TABLES;
